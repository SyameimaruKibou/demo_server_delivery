...
import extrace.misc.model.ChatMessage;
import extrace.ui.domain.ChatMessageAdapter;
import extrace.ui.util.HttpUtils;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        list.add(new ChatMessage("您好，很高兴为您服务，任何快递问题都可以找我哦~", ChatMessage.Type.INCOUNT, new Date()));
