...
//	}
	...
	public static final class STATUS{
		public static final int CREATING = -1; //创建？
		public static final int UNPACKED = 0;//未打包
		public static final int PACKED = 1;//已打包
		public static final int DELIVERIED = 2;//交付over
	}
}